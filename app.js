...
const TABS = [
  ...
  { id: 'dsports',   label: 'DSports TV',      icon: '📺' },
...
// =====================================================================
// =====================================================================
// DSPORTS TV — SELECTOR DE CANALES (ENLACES EXTERNOS)
// =====================================================================
    ...
    <div class="fade-in view-dsports" style="display: flex; flex-direction: column; gap: 1rem;">
      <div class="section-header">
        ...
        <div class="flex gap-1" style="font-size: 11px; flex-wrap: wrap;">
          ...
          <span class="badge badge-slate">${channels.length} canales</span>
        </div>
      </div>

      <div class="dsports-grid">
        ${channels.map(ch => `
          <a href="${escapeHtml(ch.url)}"
             target="_blank"
             rel="noopener noreferrer"
             class="dsports-card"
             title="Abrir ${escapeHtml(ch.name)} en nueva pestaña">
            <span class="dsports-card-num">${ch.id}</span>
            <span class="dsports-card-body">
              <span class="dsports-card-name">${escapeHtml(ch.name)}</span>
              <span class="dsports-card-region mono">${escapeHtml(ch.region)}</span>
            </span>
            <span class="dsports-card-action">↗</span>
          </a>
        `).join('')}
      </div>
    </div>
